...
class BackupController {
  ...
  static async exportExcel(req, res) {
    try {
      ...
      const { filepath, filename } = await BackupService.exportExcel({ start_date, end_date });
  ...
  static async importExcel(req, res) {
    try {
      ...
      const result = await BackupService.importExcel(req.file.path);
  ...
  static async getList(req, res) {
    try {
      const list = await BackupService.getList();
  ...
  static async restoreBackup(req, res) {
    try {
      const result = await BackupService.restoreBackup(parseInt(req.params.id));
  ...
  static async importJson(req, res) {
    try {
      ...
      const result = await BackupService.importJson(data);
